...
public class BrainLinkDemo : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        permissionManager = FindObjectOfType<BluetoothPermissionManager>();
        if (permissionManager == null)
        {
            GameObject permissionObj = new GameObject("BluetoothPermissionManager");
            permissionManager = permissionObj.AddComponent<BluetoothPermissionManager>();
        }
    ...
    public void ClickScan()
    {
        ...
        if (permissionManager != null && !permissionManager.ArePermissionsGranted())
        {
            Debug.LogWarning("Bluetooth permissions not granted. Requesting permissions...");
